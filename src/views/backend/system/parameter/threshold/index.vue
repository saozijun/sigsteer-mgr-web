<template>
    <div class="main">
        <el-table :data="tableData" height="95%" scrollbar-always-on>
            <el-table-column prop="id" label="业务间隔ID" align="center" />
            <el-table-column prop="vehicleCode" label="业务名称" align="center" />
            <el-table-column prop="frontIp" label="阈值（毫秒）" align="center" />
