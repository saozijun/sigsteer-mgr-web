<template>
    <div class="main">
        <el-table :data="tableData" height="95%" scrollbar-always-on>
            <el-table-column prop="id" label="FTP服务IP" align="center" />
            <el-table-column prop="vehicleCode" label="FTP服务端口" align="center" />
            <el-table-column prop="frontIp" label="根文件夹目录" align="center" />
            <el-table-column prop="rearIp" label="描述" align="center" />
