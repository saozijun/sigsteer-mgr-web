    ...
    <div class="map">
      <div class="map-box">
        <div class="map-box-title">
          <div class="title-item type-danger">
            CI
          </div>
    ...
    .map-box {
      ...
      .map-box-title {
        ...
        &::before {
          ...
          width: vw(50);
          height: vw(2);
          background: linear-gradient(to right, #00000000, #7fb2ffd2, #00000000);
          left: vw(326);
          top: 55%;
      ...
      .map-box-content {
        ...
        .fan-shape {
          ...
          top: 0;
          transform: translateX(-50%);
          background: linear-gradient(to top, transparent 0%, rgba(6, 151, 235, 0.1) 50%, transparent 100%);
